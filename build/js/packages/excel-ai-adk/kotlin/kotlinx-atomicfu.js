(function (factory) {
  ...
  protoOf(AtomicRef).gd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).hd = function () {
  ...
  protoOf(AtomicBoolean).id = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).hd = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).jd = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).hd = function () {
    return this.kotlinx$atomicfu$value;
  };
